...
public final class Chess extends JFrame {
    ...
    private Chess() {
        ...
        BufferedImage image = ImageReader.readImage("ChessBoard", ImageReader.PNG);
        ...
        aboutInfo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                Scanner scan = new Scanner(
                        ...
                        + " https://github.com/VisionZ/Advanced-Chess"
                );
                ...
                switch (game.getState()) {
                    case Board.WHITE_PLAYER_VS_BLACK_COMPUTER: {
                        ...
                        switch (JOptionPane.showConfirmDialog(Chess.this,
                                "Use Parallel Processing for the Black AI?\nWarning: This will use all of your device's CPU cores,\nonly do this if you have no other applications open.\nThis setting is currently " + ((game.getBlackComputer().isParallelProcessing()) ? "enabled." : "disabled."), "Parallel Processing",
                                JOptionPane.YES_NO_OPTION,
                    ...
                    case Board.BLACK_PLAYER_VS_WHITE_COMPUTER: {
                        ...
                        switch (JOptionPane.showConfirmDialog(Chess.this,
                                "Use Parallel Processing for the White AI?\nWarning:  This will use all of your device's CPU cores,\nonly do this if you have no other applications open.\nThis setting is currently " + ((game.getWhiteComputer().isParallelProcessing()) ? "enabled." : "disabled."), "Parallel Processing",
                                JOptionPane.YES_NO_OPTION,
                                JOptionPane.QUESTION_MESSAGE, icon)) {
                            case JOptionPane.YES_OPTION: {
