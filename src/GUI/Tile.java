...
public final class Tile extends Area {
    ...
    private static final BufferedImage LIGHT_TILE = ImageReader.readImage("LightTile", ImageReader.JPG);
    private static final BufferedImage LIGHT_TILE_MOVE_TINT = ImageReader.tintImage(LIGHT_TILE, Board.MOVE, 0.5f);
    private static final BufferedImage LIGHT_TILE_ATTACK_TINT = ImageReader.tintImage(LIGHT_TILE, Board.ATTACK, 0.5f);
    private static final BufferedImage LIGHT_TILE_CASTLE_TINT = ImageReader.tintImage(LIGHT_TILE, Board.CASTLE, 0.5f);
    private static final BufferedImage LIGHT_TILE_EN_PASSANT_TINT = ImageReader.tintImage(LIGHT_TILE, Board.EN_PASSANT, 0.5f);
    private static final BufferedImage LIGHT_TILE_SELECTED_TINT = ImageReader.tintImage(LIGHT_TILE, Board.SELECTED, 0.5f);

    private static final BufferedImage DARK_TILE = ImageReader.readImage("DarkTile", ImageReader.JPG);
    private static final BufferedImage DARK_TILE_MOVE_TINT = ImageReader.tintImage(DARK_TILE, Board.MOVE, 0.5f);
    private static final BufferedImage DARK_TILE_ATTACK_TINT = ImageReader.tintImage(DARK_TILE, Board.ATTACK, 0.5f);
    private static final BufferedImage DARK_TILE_CASTLE_TINT = ImageReader.tintImage(DARK_TILE, Board.CASTLE, 0.5f);
    private static final BufferedImage DARK_TILE_EN_PASSANT_TINT = ImageReader.tintImage(DARK_TILE, Board.EN_PASSANT, 0.5f);
    private static final BufferedImage DARK_TILE_SELECTED_TINT = ImageReader.tintImage(DARK_TILE, Board.SELECTED, 0.5f);
