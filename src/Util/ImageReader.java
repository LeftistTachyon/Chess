...
public final class ImageReader {
    ...
    public static BufferedImage readImage(String imageName, String imageType) {
        try {
            return ImageIO.read(ImageReader.class.getResourceAsStream(IMAGES_FOLDER + imageName + imageType));
        }
    ...
    public static Image readGIFImage(String imageName) {
        return new ImageIcon(ImageReader.class.getResource(IMAGES_FOLDER + imageName + GIF)).getImage();
    }
