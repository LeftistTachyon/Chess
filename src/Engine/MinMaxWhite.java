...
final class MinMaxWhite {
     ...
     * to reduce White's score as much as possible. This component implements
     * Black's moves.
     *
     ...
     * possible. This score may be extremely high, indicating that Black is losing
    ...
    static int min(final Grid grid, final List<Piece> whites, final List<Piece> blacks, int depth) {
        ...
        return (min == POSITIVE_INFINITY) ? checkBlackEndGame(grid, blackKing, depth + 1) : min;
    }
     ...
     * possible. This score may be extremely low, indicating that White is losing
     * or is about to be checkmated.
     */
    static int max(final Grid grid, final List<Piece> whites, final List<Piece> blacks, int depth) {
        ...
        return (max == NEGATIVE_INFINITY) ? checkWhiteEndGame(grid, whiteKing, depth + 1) : max;
    }
