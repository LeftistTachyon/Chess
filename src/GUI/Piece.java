...
public abstract class Piece extends Area implements Cloneable {
    ...
    private static final Image WHITE_BISHOP = ImageReader.readGIFImage("WhiteBishop3D");
    private static final Image WHITE_ROOK = ImageReader.readGIFImage("WhiteRook3D");
    private static final Image WHITE_QUEEN = ImageReader.readGIFImage("WhiteQueen3D");
    private static final Image WHITE_KING = ImageReader.readGIFImage("WhiteKing3D");
    
    private static final Image BLACK_PAWN = ImageReader.readGIFImage("BlackPawn3D");
    private static final Image BLACK_KNIGHT = ImageReader.readGIFImage("BlackKnight3D");
    private static final Image BLACK_BISHOP = ImageReader.readGIFImage("BlackBishop3D");
    private static final Image BLACK_ROOK = ImageReader.readGIFImage("BlackRook3D");
    private static final Image BLACK_QUEEN = ImageReader.readGIFImage("BlackQueen3D");
    private static final Image BLACK_KING = ImageReader.readGIFImage("BlackKing3D");
